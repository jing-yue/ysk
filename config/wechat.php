...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx77bfd6986bea0f4a'),         // AppID
    'secret'  => env('WECHAT_SECRET', '5addc1733605495276be718f7d2b4637'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'my_ysk'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'iYwRgOktTWtOfJ7kBWw2HjiRba1YFRtmqtrmh4LRDyX'),                    // EncodingAESKey

    // 测试
    //'app_id'  => env('WECHAT_APPID', 'wxa069671594673f20'),
    //'secret'  => env('WECHAT_SECRET', '42db52a7d53f7b0278fc5d6710dc4628'),     // AppSecret
